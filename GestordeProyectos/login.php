...
<?php
    ...
    if ($_POST){
        ...
        if ($sum>0){
            ...
            //<!-- si el pasword de la bd es igual al que carga el usuario entonceces es correcto y creamos sesion -->

                $_SESSION['id'] = $row['id'];
                $_SESSION['nombre'] = $row['nombre'];
                $_SESSION['tipo_usuario'] = $row['tipo_usuario'];

                //<! --enviamos la sesion a la principal -- >
